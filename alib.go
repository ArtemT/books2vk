...
func AlibCode(s string) string {
	codes := map[string]string {
		...
		"tbrit": "Европа: Великобритания, Ирландия, Исландия",
		...
		"tiross2": "История России (1700-1917 гг.)",
		...
		"tnauka": "Популярная научно-техническая литература",
